...
public class StrictFastMathTest extends AbstractFastMathTezt {
    ...
    public void test_floorToInt_double() {
        for (int i=0;i<NBR_OF_VALUES_SMALL;i++) {
            ...
            int res = StrictFastMath.floorToInt(value);
            assertEquals(ref, res);
        }
    }
    ...
    public void test_ceilToInt_double() {
        for (int i=0;i<NBR_OF_VALUES_SMALL;i++) {
            ...
            int res = StrictFastMath.ceilToInt(value);
            assertEquals(ref, res);
        }
    }
    ...
    public void test_roundToInt_double() {
        for (int i=0;i<NBR_OF_VALUES_SMALL;i++) {
            ...
            int res = StrictFastMath.roundToInt(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
                System.out.println("value = "+value);
    ...
    public void test_roundEvenToInt_double() {
        for (int i=0;i<NBR_OF_VALUES_SMALL;i++) {
            ...
            int res = StrictFastMath.roundEvenToInt(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
                System.out.println("value = "+value);
